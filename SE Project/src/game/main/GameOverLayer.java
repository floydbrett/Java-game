...
public class GameOverLayer implements LayerImplement{
    ...
    public GameOverLayer() {
        layer.setName("GameOverLayer");
        layer.setBlocks(false, true, false);
        buttons = new String[]{"Main Menu", "Exit Game"};
    }
    ...
    public void render(BufferStrategy bs) {
        ...
        g.setFont(menuFont);
        g.drawString("Game Over", winWidth - 450, winHeight - 280);
        g.setColor(Color.WHITE);
